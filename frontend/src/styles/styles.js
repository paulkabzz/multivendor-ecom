const styles = {
  ...
  productTitle: "text-[20px] font-[600] font-Roboto mb-5 text-[#333]",
  ...
  shop_name: "pt-3 text-[15px] text-[#2096f3] pb-1",
  active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
  button:
    "w-[150px] h-[50px] text-[14px] my-3 flex items-center justify-center cursor-pointer",
  cart_button:
